---
description: Open a new branch and implement the current feature from context/current-feature.md
---
...
1. **Read** `context/current-feature.md` to understand the feature name, status, goals, and notes. If the file has no active feature (empty title/goals), stop and tell me.
